...
print('sums are larger than the previous sum: {}'.format(larger_than_previous(number_list)))
print('Groups of sums larger than the previous: {}'.format(three_measurement_sliding_window_sum(number_list)))
